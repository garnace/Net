...
//Double check pipes                                                                                  
    ...
    if (close(fd) == -1)
      {
         printf("An n7l6error occurred while closing the sr pipe\n");
         //exit(0);                                                                                   
      }
    ...
    // Open the pipe for reading                                                                      
    fe = open(link6, O_WRONLY);

    // write to the pipe                                                                              
      write(fe, "N7DONE", strlen("N7DONE"));

      // Close the pipe                                                                               
    if (close(fe) == -1)
      {
         printf("An n7l6werror occurred while closing the sw pipe\n");
        // exit(0);                                                                                   
      }
